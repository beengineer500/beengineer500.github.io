...
<figure>
  <img src="03-why-e-waits.webp" alt="batch_size 4와 batch_size 100 두 타임라인이 나란히 있고, 둘 다 새 요청이 진행 중인 라운드가 끝난 뒤에야 시작되는 것을 화살표로 보여주는 도식">
...
/generate_vllm  780.49 req/s × 86,400초 ≈ 하루 6,745만 건
```
